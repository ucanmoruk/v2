...
namespace StokTakip
{
    public partial class Personel : Form
    {
        ...
        void personeldetay()
        {
            SqlCommand komut21 = new SqlCommand("Select * from StokKullanici where ID = N'" + update + "' ", bgl.baglanti());
            ...
            SqlCommand komut2 = new SqlCommand("Select * from StokFirmaBirim where ID = N'" + birimID + "' ", bgl.baglanti());
            SqlDataReader dr2 = komut2.ExecuteReader();
            while (dr2.Read())
            {
        ...
        private void btn_ekle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {                    
                        ...
                        SqlCommand add = new SqlCommand("update StokKullanici set BirimID=@o2,  Ad=@o4, Soyad=@o5, Gorev=@o6, Email=@o7,Telefon=@o8,Parola=@o9,Durum=@o10 where ID = N'" + PersonelListesi.kkod + "' ", bgl.baglanti());
                ...
                else
                {
                    ...
                    {
                        kad = txt_ad.Text + "." + txt_soyad.Text;
                        SqlCommand add = new SqlCommand("insert into StokKullanici(FirmaID, BirimID, Kadi, Ad, Soyad, Gorev, Email,Telefon,Parola,Durum) values (@o1,@o2, @o3, @o4, @o5, @o6, @o7, @o8, @o9, @o10)", bgl.baglanti());
