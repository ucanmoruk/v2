...
namespace mKYS.Talep
{
    public partial class MaaliyetEkle : Form
    {
        ...
        void listele()
        {
            ...
            SqlDataAdapter da2 = new SqlDataAdapter(" select d.StokKod, l.Ad, d.Miktar, d.Birim, m.BirimFiyat, m.TL, m.Dolar, m.Euro, m.Tarih, t.Ad as 'Firma Adı' from RootTalepDetay d " +
                "inner join RootStokListesi l on d.StokKod = l.Kod  " +
                "left join  RootStokMaliyet m on d.StokKod = m.StokKod  left join RootStokTedarikci t on m.TedarikciID = t.ID " +
            ...
            SqlCommand komut2 = new SqlCommand("select Ad from RootStokTedarikci where Durum = 'Aktif'", bgl.baglanti());
        ...
        {
            DataTable dt2 = new DataTable();
            SqlDataAdapter da2 = new SqlDataAdapter(" select d.StokKod, l.Ad, d.Miktar, d.Birim, m.BirimFiyat, m.TL, m.Dolar, m.Euro, m.Tarih, t.Ad as 'Firma Adı' from RootStokTalepDetay d " +
                "inner join RootStokListesi l on d.StokKod = l.Kod  " +
                "left join  RootStokMaliyet m on d.StokKod = m.StokKod  left join RootStokTedarikci t on m.TedarikciID = t.ID " +
        ...
        public void eskisil()
        {
            SqlCommand add = new SqlCommand("delete from RootStokMaliyet where TalepNo = @p1 and StokKod = @p2 ", bgl.baglanti());
        ...
        void kayital()
        {
            for (int ik = 0; ik < gridView1.RowCount; ik++)
            {
                ...
                {
                    SqlCommand komut21 = new SqlCommand("Select ID from RootStokTedarikci where Ad = N'" + firmaadi + "' ", bgl.baglanti());
                    ...
                    else
                    {
                        ...
                        SqlCommand komutz = new SqlCommand("insert into RootStokMaliyet (TedarikciID, TalepNo, StokKod, Durum, Tarih, BirimFiyat, Tl, Dolar, Euro) values (@a1, @a2, @a3, @a9, @a4,@a5, @a6, @a7, @a8)", bgl.baglanti());
