...
namespace mKYS.Talep
{
    public partial class MaliyetListesi : Form
    {
        ...
        public void listele()
        {
            ...
            t.Ad as 'Tedarikçi', m.ID from RootStokMaliyet m 
            left join RootTalepDetay d on m.tID = d.ID
            left join RootStokListesi l on d.StokKod = l.Kod 
            left join RootTedarikci t on m.TedarikciID = t.ID 
            where m.Durum = 'Aktif' 
