...
namespace mKYS
{
    public partial class TalepListesi : Form
    {
        ...
        public void listele()
        {
            ...
            SqlDataAdapter da2 = new SqlDataAdapter("select l.TalepNo, l.Olusturma as 'Talep Tarihi', k.Ad + ' ' + k.Soyad as 'Talep Oluşturan', l.Durum, z.Ad + ' ' + z.Soyad as 'Değerlendiren', l.Onaylama as 'Değerlendirme Tarihi', b.Ad + ' ' + b.Soyad as 'İşleme Alan', l.Isleme as 'İşleme Alınma Tarihi' from RootTalepListe l " +
                "left join RootKullanici k on l.TalepEdenID= k.ID left join RootKullanici z on l.OnaylayanID = z.ID left join RootKullanici b on l.IsleyenID = b.ID " +
        ...
        void kullanicibul()
        {
            SqlCommand komut21 = new SqlCommand("Select * from RootTalepListe where TalepNo = '" + talepno+"'", bgl.baglanti());
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (Secim == DialogResult.Yes)
            {
                ...
                SqlCommand add2 = new SqlCommand("update RootTalepListe set IsleyenID=@o1, Isleme=@o2, Durum=@o3 where TalepNo = '" + talepno + "'", bgl.baglanti());
        ...
        private void barButtonItem4_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (olusturan == Anasayfa.tamad)
            {
                ...
                if (Secim == DialogResult.Yes)
                {
                    ...
                    SqlCommand add2 = new SqlCommand("update RootTalepListe set Aktif=@o1 where TalepNo = '" + talepno + "'", bgl.baglanti());
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (Secim == DialogResult.Yes)
            {
                ...
                SqlCommand add2 = new SqlCommand("update RootTalepListe set OnaylayanID=@o1, Onaylama=@o2, Durum=@o3 where TalepNo = '" + talepno+"'", bgl.baglanti());
                add2.Parameters.AddWithValue("@o1", Anasayfa.kullanici);
                add2.Parameters.AddWithValue("@o2", tarih);
