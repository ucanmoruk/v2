...
namespace mKYS
{
    public partial class TalepDetay : Form
    {
        ...
        void listele()
        {
            ...
            SqlDataAdapter da2 = new SqlDataAdapter("select d.StokKod as 'Stok Kodu', l.Ad, l.Cas as 'Cas No', d.Miktar,d.Birim, d.Marka, d.Ozellik, d.Durum, d.ID from RootTalepDetay d " +
                "left join RootStokListesi l on d.StokKod = l.Kod where TalepNo = '" + TalepNo+"' and d.Durumu = 'Aktif' order by d.StokKod", bgl.baglanti());
            da2.Fill(dt2);
