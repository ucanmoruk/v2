...
{
    public partial class STalepDetay : Form
    {
        public STalepDetay()
        {
            InitializeComponent();
        ...
        public void listele()
        {
            ...
            SqlDataAdapter da2 = new SqlDataAdapter(@"select TalepNo, Tarih, Kategori, Durum, Detay, ID from STalepListe t 
            where GenelDurum = 'Aktif' order by t.TalepNo desc 
            ", bgl.baglanti());
            da2.Fill(dt2);
            ...
            gridView1.Columns["Tarih"].AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
        ...
        private void gridView1_CustomDrawCell(object sender, DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs e)
        {
         ...
         //   string odeme = gridView1.GetRowCellValue(e.RowHandle, "Odeme").ToString();
            ...
            if (e.RowHandle > -1 && e.Column.FieldName == "Durum" && durum == "Araştırılıyor")
