...
{
    public partial class SStokListesi : Form
    {
        public SStokListesi()
        {
            InitializeComponent();
        ...
        public void listele()
        {
            ...
            SqlDataAdapter da2 = new SqlDataAdapter(@"select Kategori, Marka, Ad, Kod, Lot, CONCAT(Stok, ' ', Birim) as 'Stok Miktarı', CONCAT(Satis, ' ', ParaBirimi) as 'Satış Fiyatı', Notlar, ID from SStokListe 
            where Durum = 'Aktif' order by Kategori", bgl.baglanti());
        ...
        {
            if (e.Column.FieldName == "Stok Miktarı" || e.Column.FieldName == "Satış Fiyatı")
