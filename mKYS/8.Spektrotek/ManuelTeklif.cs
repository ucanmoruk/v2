...
{
    public partial class ManuelTeklif : Form
    {
        public ManuelTeklif()
        {
            InitializeComponent();
        ...
        void listele()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter(@"h.Kod, CONCAT(h.Marka,' ',h.Ad) as 'Açıklama', d.Miktar as 'Adet', 
            d.Fiyat as 'BirimFiyat', d.KDV as 'KDV (%)', d.Tutar as 'Toplam (KDV Hariç)'
            from STeklifDetay d
        ...
        private void gridstyle()
        {
            ...
            GridColumnSummaryItem item = new GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "Toplam (KDV Hariç)", "{0:C}");
