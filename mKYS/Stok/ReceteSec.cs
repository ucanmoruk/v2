...
namespace mKYS.Stok
{
    public partial class ReceteSec : Form
    {
        ...
        private void listele()
        {
            ...
            SqlDataAdapter da2 = new SqlDataAdapter("Select ID, Kod, Ad From StokAnalizListesi where Durumu = 'Aktif' and ID not in (select distinct AnalizID from StokRecete) order by Kod ", bgl.baglanti());
            da2.Fill(dt2);
