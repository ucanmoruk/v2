...
namespace mKYS.Cihaz
{
    public partial class CihazMaliyet : Form
    {
        ...
        void listele()
        {
            ...
            SqlDataAdapter da5 = new SqlDataAdapter("select ID, Kod + ' ' + Ad as 'Cihaz' from CihazListesi where Durum= 'Aktif'", bgl.baglanti());
            da5.Fill(dt5);
        ...
        void ekleme()
        {
            SqlCommand add = new SqlCommand(" insert into CihazMaliyet (CihazID, FirmaID, Tarih, Aciklama, Tl, Dolar, Euro, Durum) values (@a1, @a2, @a3, @a4, @a5, @a6,@a7,@a8)", bgl.baglanti());
