    ...
    public partial class KalibrasyonSartname : Form
    {
        ...
        public void listele()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter(@"Select c.CihazID, l.Kod, l.Ad, c.KalTip as 'Tür', c.KalSiklik as 'Sıklık', c.Calisma as 'Çalışma Aralığı',  
             ...
             from CihazKalibrasyon c 
             inner join CihazListesi l on c.CihazID = l.ID 
             inner join StokDKDListe d on c.Kaynak = d.ID 
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                SqlCommand komutSil = new SqlCommand("update CihazKalibrasyon set Durum=@a1 where CihazID = N'" + cID + "' ", bgl.baglanti());
