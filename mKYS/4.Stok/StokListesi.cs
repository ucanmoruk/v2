...
namespace mKYS
{
    public partial class StokListesi : Form
    {
        ...
        public void listele()
        {
            ...
            //            SqlDataAdapter da2 = new SqlDataAdapter(@"select ID, Tur as 'Tür', Kod, Ad, AdEn as 'İngilizce', AdInci as 'INCI Adı', Cas as 'Cas No', Ozellik, 
            //Ambalaj, Saklama as 'Saklama Koşulları',
            //CONVERT(nvarchar,REPLACE(Limit,',',''))+' '+Birim as 'Kritik Limit',
            //CONVERT(nvarchar,REPLACE(Miktar,',',''))+' '+Birim as 'Stok Durumu'
            //from RootStokListesi sl 
            //where Durum = N'Aktif' order by Tur", bgl.baglanti());
            SqlDataAdapter da2 = new SqlDataAdapter(@"select sl.ID, sl.Tur as 'Tür', sl.Kod, sl.Ad, sl.AdEn as 'İngilizce', 
            sl.AdInci as 'INCI Adı', sl.Cas as 'Cas No', Ozellik, 
            Ambalaj, Saklama as 'Saklama Koşulları',
            sl.Limit as 'Kritik Limit', sl.Miktar as 'Stok Durumu', Birim from RootStokListesi sl 
            where Durum = N'Aktif' order by Tur", bgl.baglanti());
            ...
            this.gridView1.Columns[12].Width = 50;
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                if (Secim == DialogResult.Yes)
                {
                    ...
                    SqlCommand komutSil = new SqlCommand("update RootStokListesi set Durum=@a1, Kod = @a2 where ID = N'"+id+"'", bgl.baglanti());
