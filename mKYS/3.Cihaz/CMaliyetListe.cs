...
namespace mKYS.Cihaz
{
    public partial class CMaliyetListe : Form
    {
        ...
        public void listele()
        {
            ...
            SqlDataAdapter da6 = new SqlDataAdapter("select m.ID, l.Kod, l.Ad, l.Marka,  m.Aciklama as 'Açıklama', m.Tarih, m.Tl,m.Dolar, m.Euro, s.Ad as 'Firma' from RootCihazMaliyet m" +
                " left join RootCihazListesi l on m.CihazID = l.ID left join RootTedarikci s on m.FirmaID = s.ID where m.Durum = 'Aktif' ", bgl.baglanti());
            da6.Fill(dt6);
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                SqlCommand komutSil = new SqlCommand("update RootCihazMaliyet set Durum=@a1 where ID = N'" + mID + "' ", bgl.baglanti());
