    ...
    public partial class CihazEkle : Form
    {
        ...
        public void listele4()
        {
            ...
            SqlDataAdapter da7 = new SqlDataAdapter("select i.ID, i.Tur as 'İşlem Türü', i.Tarih1 as 'Tarih', i.Aciklama as 'Açıklama', case i.Finout " +
                ...
                "from RootCihazIslem i left join RootTedarikci t on i.FirmaID = t.ID left join RootKullanici k on i.PersonelID = k.ID " +
        ...
        void detaybul()
        {
            if (cihazkod == "1")
            {
                SqlCommand komutID = new SqlCommand("Select * From RootCihazListesi where ID= N'" + cID + "'", bgl.baglanti());
            ...
            {
                SqlCommand komutID = new SqlCommand("Select * From RootCihazKalibrasyon where CihazID= N'" + cID + "' and Durum = N'Aktif'", bgl.baglanti());
                SqlDataReader drI = komutID.ExecuteReader();
                while (drI.Read())
                {
                ...
                SqlCommand komutI = new SqlCommand("Select * From RootCihazBakim where CihazID= N'" + cID + "' and Durum = N'Aktif'", bgl.baglanti());
        ...
        void detay2()
        {
            ...
            SqlCommand komutI = new SqlCommand("Select * From RootCihazKalibrasyon where CihazID= N'" + cID + "' and Durum = N'Aktif'", bgl.baglanti());
            SqlDataReader dr = komutI.ExecuteReader();
            while (dr.Read())
            {
            ...
            SqlCommand komutIx = new SqlCommand("Select * From RootCihazBakim where CihazID= N'" + cID + "' and Durum = N'Aktif'", bgl.baglanti());
        ...
        void ekleme()
        {
            ...
            {
                SqlCommand add = new SqlCommand(" insert into RootCihazListesi (Kod, Ad, Marka, Seri, FirmaID, BirimID, TalimatID, Tarih, Ozellik,Durumu,Durum) values (@a1, @a2, @a3, @a4, @a5, @a6,@a7,@a8,@a9,@a10,@a11) SET @ID = SCOPE_IDENTITY() ", bgl.baglanti());
        ...
        void guncelle()
        {
            ...
            {
                SqlCommand add = new SqlCommand(" update RootCihazListesi set Kod=@a1, Ad=@a2, Marka=@a3, Seri=@a4, FirmaID=@a5, BirimID=@a6, TalimatID=@a7, Tarih=@a8, Ozellik=@a9,Durumu=@a10 where ID = '" + cID+"' ", bgl.baglanti());
                add.Parameters.AddWithValue("@a1", txt_kod.Text);
                add.Parameters.AddWithValue("@a2", txt_ad.Text);
                add.Parameters.AddWithValue("@a3", txt_marka.Text);
                add.Parameters.AddWithValue("@a4", txt_seri.Text);
        ...
        void eklekal()
        {
            ...
            {
                SqlCommand add = new SqlCommand("insert into RootCihazKalibrasyon (CihazID, KalTip, KalSiklik, AraSiklik, Calisma,Kalibrasyon,Kaynak,KabulKriteri, Durum) values (@a1, @a2, @a3, @a4, @a5, @a6,@a7,@a8, @a9)", bgl.baglanti());
        ...
        void eklebakim()
        {
            ...
            {
                SqlCommand add = new SqlCommand("insert into RootCihazBakim (CihazID, PfSiklik, PfDetay, BakimSiklik,BakimDetay, Durum) values (@o1, @o2, @o3, @o4, @o5, @o6) ", bgl.baglanti());
        ...
        void guncellekal()
        {
            SqlCommand add = new SqlCommand("update RootCihazKalibrasyon set KalTip=@a2, KalSiklik=@a3, AraSiklik=@a4, Calisma=@a5,Kalibrasyon=@a6,Kaynak=@a7,KabulKriteri=@a8 where CihazID = '" + cID+"' " , bgl.baglanti());
            add.Parameters.AddWithValue("@a2", kal_tip.Text);
            add.Parameters.AddWithValue("@a3", kal_siklik.Text);
            add.Parameters.AddWithValue("@a4", ara_siklik.Text);
            add.Parameters.AddWithValue("@a5", kal_calisma.Text);
        ...
        void guncellebakim()
        {
            SqlCommand add = new SqlCommand("update RootCihazBakim set PfSiklik=@o2, PfDetay=@o3, BakimSiklik=@o4,BakimDetay=@o5 where CihazID = '" + cID + "'", bgl.baglanti());
            add.Parameters.AddWithValue("@o2", pf_siklik.Text);
            add.Parameters.AddWithValue("@o3", pf_detay.Text);
            add.Parameters.AddWithValue("@o4", bkm_siklik.Text);
            add.Parameters.AddWithValue("@o5", bkm_detay.Text);
        ...
        void kontrolkal()
        {
            SqlCommand komutI = new SqlCommand("select Count(ID) from RootCihazKalibrasyon where CihazID= N'" + cID + "' and Durum = 'Aktif'", bgl.baglanti());
            SqlDataReader dr = komutI.ExecuteReader();
            while (dr.Read())
            {
        ...
        void kontrolbakim()
        {
            SqlCommand komutI = new SqlCommand("select Count(ID) from RootCihazBakim where CihazID= N'" + cID + "' and Durum = 'Aktif'", bgl.baglanti());
            SqlDataReader dr = komutI.ExecuteReader();
            while (dr.Read())
            {
