...
from RootCihazBakim b inner join RootCihazListesi l on b.CihazID = l.ID 
where b.Durum = 'Aktif' and l.Durumu = 'Kullanımda'  order by l.Kod", bgl.baglanti());
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                SqlCommand komutSil = new SqlCommand("update RootCihazBakim set Durum=@a1 where CihazID = N'" + cID + "' ", bgl.baglanti());
