...
namespace mKYS.Duyuru
{
    public partial class Duyurularim : Form
    {
        ...
        public void listele()
        {
            ...
            SqlDataAdapter da2 = new SqlDataAdapter("select d.ID,  d.Tarih as 'Mesaj Tarihi', d.Konu, d.Duyuru as 'Mesaj', k2.Ad + ' ' + k2.Soyad as 'Alıcı', m.Durum, m.Tarih as 'Okunma Tarihi' from RootMesaj d " +
                " inner join RootKullanici k on d.PersonelID = k.ID inner join RootMesajDurum m on d.ID = m.DuyuruID inner join RootKullanici k2 on m.PersonelID = k2.ID " +
